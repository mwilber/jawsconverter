...
<head>
	...
	<meta name="description" content="Measure your world in terms of Sharks!">
	<meta name="author" content="Matthew Wilber">
	<meta property="og:title" content="JAWS Converter" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="http://jawsconverter.com/" />
	<meta property="og:image" content="http://jawsconverter.com/images/fp_icon.png" />
	<meta property="og:site_name" content="JAWS Converter" />
	<meta property="fb:admins" content="631337813" />
	<meta property="og:description" content="Measure your world in terms of Sharks!" />
	...
	<script type="text/javascript" language="javascript">
	        ...
	        function onDeviceReady() {
	            ...
	            AppMobi.display.useViewport(810,1024);
	...
	<style type="text/css">
		...
		#frmmeasure #measureUnit, #frmmeasure input#measureSource, #frmmeasure input#measureConvert {
			height: 70px;
			width: 500px;
			margin: 10px 60px;
			font-size: 30px;
		}
		#frmmeasure input#measureSource{
			width:480px;
			height:50px;
		}
		#frmmeasure input#measureConvert{
			height: 80px;
		}
		#aboutbox {
			top: 20%;
...
<div id="container">
	...
	<div id="main" role="main">
		...
		<div id="menubar">
			<div>
				<span>SHARE:</span>
				<a id="tweeters" href="#" onclick="return false;"><img src="images/btn_tw.png" alt="Tweeters" width="50" height="50"/></a>
				<a id="facebook" href="#" onclick="return false;"><img src="images/btn_fb.png" alt="facebook" width="50" height="50"/></a>
				<a id="googleplus" href="#" onclick="return false;"><img src="images/btn_gp.png" alt="google plus" width="50" height="50"/></a>
				<a id="info" href="#" onclick="return false;"><img src="images/btn_info.png" alt="info" width="50" height="50"/></a>
			</div>
		</div>
		<form id="frmmeasure">
...
<script src="js/scriptmobi.js"></script>
<script type="text/javascript">
